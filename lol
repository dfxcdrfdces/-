firesignal(game.ReplicatedStorage.EntityInfo.Caption.OnClientEvent, 'scipt Hardloos')
wait("2.4")
firesignal(game.ReplicatedStorage.EntityInfo.Caption.OnClientEvent, 'By wweuuweyuwe ')
wait("2.4")
firesignal(game.ReplicatedStorage.EntityInfo.Caption.OnClientEvent, 'Anyway ')
wait("2.4")
firesignal(game.ReplicatedStorage.EntityInfo.Caption.OnClientEvent, 'Good Luck ')
wait("2.4")
--[=[
@class txt
...
function Depth()
    ...
    pcall(function()
        ...
        local Depth = Creator.createEntity({
            CustomName = "SOLE", -- Custom name of your entity
            Model = "rbxassetid://12714695608", -- Can be GitHub file or rbxassetid
            Speed = 119, -- Percentage, 100 = default Rush speed
            DelayTime = 2,
...
Depth.Debug.OnEntityDespawned = function()
        ...
        while true do task.wait()
            pcall(function()
                ...
                local entity = Creator.createEntity({
                    ...
                    Model = "  rbxassetid://12714912664", -- Can be GitHub file or rbxassetid
        ...
        while true do wait(200)
            pcall(function()
                ...
                local entity2 = Creator.createEntity({
                    CustomName = "OOLS", -- Custom name of your entity
                    Model = "  rbxassetid://12714923931", -- Can be GitHub file or rbxassetid
                    Speed = 79, -- Percentage, 100 = default Rush speed
    ...
    local function ZoO()
        ...
        local ZoO = Creator.createEntity({
            ...
            Model = "rbxassetid://12717050001", -- Can be GitHub file or rbxassetid
            Speed = 99, -- Percentage, 100 = default Rush speed
    ...
    function TraumaSpawn()
        while true do 
            ...
            local Trauma = Creator.createEntity({
                CustomName = "Bols", -- Custom name of your entity
                Model = "rbxassetid://12717034433", -- Can be GitHub file or rbxassetid
                Speed = 117, -- Percentage, 100 = default Rush speed
                DelayTime = 2,
